...
chcp 65001 > nul
REM ============================================
REM Script: cargar_almalmacen_almubimapa.bat
REM Carga inicial de tablas para vista almacen 3D:
REM   - almalmacen  (definicion de almacenes)
REM   - almubimapa  (mapa de ubicaciones)
REM
...
echo.
echo ============================================
echo    CARGAR TABLAS ALMACEN 3D
echo ============================================
echo.
echo    ORIGEN:  %SERVIDOR_ORIGEN% / %BD%
echo    DESTINO: %SERVIDOR_DESTINO% / %BD%
echo.
echo    Tablas: almalmacen, almubimapa
echo.
echo ============================================
echo.
...
call :migrar_tabla almalmacen
call :migrar_tabla almubimapa

echo.
echo [4] Creando PRIMARY KEYS...
SET TABLAS_SQL='almalmacen','almubimapa'
SET PKS_FILE=%DATOS%\pks_almacen.sql
...
SET INDICES_FILE=%DATOS%\indices_almacen.sql
...
sqlcmd -S %SERVIDOR_DESTINO% -U %USUARIO_DESTINO% -P %CLAVE_DESTINO% -d %BD% -Q "SET NOCOUNT ON; SELECT 'almalmacen', COUNT(*) FROM dbo.almalmacen UNION ALL SELECT 'almubimapa', COUNT(*) FROM dbo.almubimapa" -W -s" | "
echo.
echo ============================================
echo TABLAS ALMACEN CARGADAS
echo ============================================
echo.
echo Ahora el sincronizar_cristal.bat las mantendra
echo actualizadas automaticamente.
echo.
pause
exit /b 0
