-- ============================================================================
-- Script: 11_alter_view_externos_stock_add_packaging.sql
-- Descripción: Actualiza vista para incluir unidadescaja y cajaspallet
-- Fecha: 2025-12-29
-- ============================================================================
...
IF EXISTS (SELECT 1 FROM sys.views WHERE name = 'view_externos_stock')
BEGIN
    DROP VIEW view_externos_stock;
    PRINT 'Vista view_externos_stock eliminada para recrear';
END
GO

-- Recrear vista con campos de empaquetado
...
PRINT 'Vista view_externos_stock actualizada con campos de empaquetado';
GO

-- Verificar datos de la vista con nuevos campos
SELECT TOP 10
    empresa,
    codigo,
    descripcion,
...
PRINT 'Vista: view_externos_stock';
PRINT 'Nuevos campos: unidadescaja, cajaspallet';
PRINT '============================================================================';
