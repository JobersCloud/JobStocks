...
class User(UserMixin):
    def __init__(self, id, username, email=None, full_name=None, rol='usuario', empresa_id='1', cliente_id=None, debe_cambiar_password=False, company_name=None, mostrar_precios=False, administrador_clientes=False, visible_pedidos=True, visible_albaranes=False, visible_facturas=False, visible_propuestas=True, visible_stock_anulados=False, control=None):
        self.id = id
        ...
        self.visible_propuestas = visible_propuestas
        self.visible_stock_anulados = visible_stock_anulados
