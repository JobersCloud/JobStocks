#!/bin/bash
# ============================================================
# Script para configurar HTTPS en servidor OVH para UNDEFASA
# Dominio: stocks.undefasa.com
...
cp /opt/ApiRestExternos/deploy/nginx-undefasa.conf /etc/nginx/sites-available/stocks-undefasa
ln -sf /etc/nginx/sites-available/stocks-undefasa /etc/nginx/sites-enabled/
